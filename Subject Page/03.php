            ...
            <div class="container">
                <div class="left-container">
                    ...
                    <div class="thread uploads">
                        <h3>LATEST UPLOADS IN UE18CS203</h3>
                        <div class="upload-container" id="upload-container">
                        </div>    
                    </div>
                    <div class="thread uploads">
                        <h3>LATEST THREADS ON UE18CS203</h3>
                ...
                <div class="right-container">
                    <div id="upcoming">
                        ...
                        <p>COURSE CODE: UE18CS203</p>
                        <p>SEMESTER: 3</p>
                        <p>ANCHOR: Mamatha H R</p>
                    </div>
                    
                    <div id="new-thread">
                        <h5>Start a thread on Discrete Mathematics</h5>
