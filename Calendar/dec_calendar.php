...
<head>
    ...
    <div class="cal">
        <button onclick="window.location.href='calendar2.php'" id="nav">Back to November</button>
    ...
    var weekday = Calendar.getDay()+20;   
    ...
    <script>
            ...
            if(localStorage.key(0))
                    {  j=0;
                        ...
                        {   j++;
                            if(localStorage.key(i).slice(0,8)==='December')
                            {
